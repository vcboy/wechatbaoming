    ...
    <div id="filter_show" class="widget-body">
        <div class="widget-main">
            ...
            ?>
                ...
                <?= $form->field($model, 'channel_id')->dropDownList(array(''=>'--请选择--')+$channel_list,['class'=>'input-big','id'=>'course-channel-id']) ?>
                <?= $form->field($model, 'status')->dropDownList(array(''=>'--请选择--')+$status_list,['class'=>'input-big','id'=>'course-status']) ?>
