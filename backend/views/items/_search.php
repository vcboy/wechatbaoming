...
?>
<?php $status_list=Yii::$app->params['video_status'];?>
<div class="widget-box widget_tableDiv">
    ...
    <div id="filter_show" class="widget-body">
        <div class="widget-main">
            ...
            ?>
                <?= $form->field($model, 'videoName')->input('text',['class'=>'input-big']) ?>
                <?= $form->field($model, 'typeId')->dropDownList(array(''=>'--请选择--')+$type_list,['class'=>'input-big','id'=>'items-typeId']) ?>
                <?= $form->field($model, 'status')->dropDownList(array(''=>'--请选择--')+$status_list,['class'=>'input-big','id'=>'items-status']) ?>
