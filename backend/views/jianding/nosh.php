...
<?php
    $taxis_url = Url::to(['jianding/shenhe']);
    //判断权限需要用到的参数
    $auth = Yii::$app->authManager;
    $userid = Yii::$app->user->identity->id;
    //if($auth->checkAccess($userid,'menu_taxis')) {
        echo Html::input("button", "", "通过审核", ["class" => "btn btn-sm btn-primary", "onclick" => "javascript:update_record('$taxis_url', 'gridview_form', '您还未选择内容，请勾选后再进行操作')"]);
    //}
    ?>
</form>
</div>
