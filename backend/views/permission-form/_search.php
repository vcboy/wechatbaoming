...
/* @var $model backend\models\PermissionFormSearch */
...
<div class="widget-box widget_tableDiv">
    ...
    <div id="filter_show" class="widget-body">
        <div class="widget-main">
            ...
            <?= $form->field($model, 'menu_id',['labelOptions' => ['style' => 'width:100px;']])->dropDownList($menuList) ?>
...
<script type="text/javascript">
    $("#permissionformsearch-menu_id").chosen({
        width : "180px",
    });
</script>