    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="width: 80%;">书香校园</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            ?>
            <li class="active"><a href="<?=url('userbook/index')?>">欢迎 <?=$user['name']?>,点击进入个人书吧</a><a href="<?=url('default/logout')?>">退出</a></li>
            <?php
            }
            ?>
          </ul>
