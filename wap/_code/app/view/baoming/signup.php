                    ...
                    <!-- <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <label class="checkbox-inline">
                              <input type="checkbox" id="inlineCheckbox1" value="option1"> 理论
                            </label>
                            <label class="checkbox-inline">
                              <input type="checkbox" id="inlineCheckbox2" value="option2"> 技能
                            </label>
                            <label class="checkbox-inline">
                              <input type="checkbox" id="inlineCheckbox3" value="option3"> 综合评审
                            </label>
                            <label class="checkbox-inline">
                              <input type="checkbox" id="inlineCheckbox1" value="option1"> 理论
                            </label>
                            ...
                            <label class="checkbox-inline">
                              <input type="checkbox" id="inlineCheckbox33" value="option3"> 综合评审
                            </label>
                        </div>
                    </div> -->
                    <div id = "template"  style="display: none">
                      <div id="entry{n}" class="clonedInput divedu">
                        ...
                        <fieldset>
                          ...
                          <div class="form-group">
                              <select class="select_ttl form-control" name="education_edu{n}" id="education_edu{n}">
