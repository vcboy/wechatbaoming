            ...
            <div class="col-md-8">
                ...
                <form name="sentMessage" id="contactForm" novalidate>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>户口性质:</label>
                            <select class="form-control" id="hukou_type">
                            <?php
                              foreach ($hukou_type as $key => $value) {
                                echo "<option value='".$key."'>".$value."</option>";
                              }
                            ?>
                            </select>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>通讯地址:</label>
                            <input type="text" class="form-control" id="address" required data-validation-required-message="请输入通讯地址.">
                        </div>
                    </div> 
                    <div class="control-group form-group">
                        <div class="controls">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>手机号码:</label>
                            <input type="text" class="form-control" id="phone" required data-validation-required-message="请输入手机号码.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>电子邮箱:</label>
                            <input type="email" class="form-control" id="email" required data-validation-required-message="请输入电子邮箱.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>现职业资格:</label>
                            <select class="form-control" id="zhiye_type">
                            <?php
                              foreach ($zhiye_type as $key => $value) {
                                echo "<option value='".$key."'>".$value."</option>";
                              }
                            ?>
                            </select>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>现职称:</label>
                            <select class="form-control" id="zhicheng_type">
                            <?php
                              foreach ($zhicheng_type as $key => $value) {
                                echo "<option value='".$key."'>".$value."</option>";
                              }
                            ?>
                            </select>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>申报职业:</label>
                            <input type="text" class="form-control" id="sbzy" data-validation-required-message="请输入专科专业.">
                        </div>
                    </div> 
                    <!--下拉选择-->
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>申报级别:</label>
                            <select class="form-control" id="sbjb">
                            <?php
                              foreach ($sb_sources as $key => $value) {
                                echo "<option value='".$key."'>".$value."</option>";
                              }
                            ?>
                            </select>
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>考试类型:</label>
                            <label class="radio-inline">
                              <input type="radio" name="examtype" id="inlineRadio3" value="1"> 新考
                            </label>
                            <label class="radio-inline">
                              <input type="radio" name="examtype" id="inlineRadio4" value="0"> 补考
                            </label>
                        </div>
                    </div>
                    <!--下拉选择-->
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>考核科目:</label>
                            <select class="form-control" id="khkm">
                            <?php
                              foreach ($exam_sources as $key => $value) {
                                echo "<option value='".$key."'>".$value."</option>";
                              }
                            ?>
                            </select>
                    ...
                    <!-- Button (Double) -->
                    <p>
                    <button type="button" id="btnAdd_work" name="btnAdd_work" class="btn btn-info">add section</button>
                      <button type="button" id="btnDel_work" name="btnDel_work" class="btn btn-danger">remove section above</button>
                    </p>
