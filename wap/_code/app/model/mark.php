...
/**
 * Mark 封装来自 wx_mark 数据表的记录及领域逻辑
 */
class Mark extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                ...
                'course_score' => array
                (
                    array('is_int', '课程评分必须是一个整数'),

                ),

                'teacher_score' => array
                (
                    array('is_int', '教师评分必须是一个整数'),

                ),

                'teacher_id' => array
                (
                    array('is_int', '教师id必须是一个整数'),

                ),

                'course_id' => array
                (
                    array('is_int', '课程id必须是一个整数'),

                ),

                'datetime' => array
                (
                    array('is_int', '创建时间必须是一个整数'),

                ),

                'is_delete' => array
                (
                    array('is_int', 'is_delete必须是一个整数'),
