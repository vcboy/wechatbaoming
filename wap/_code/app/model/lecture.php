 ...
 */
class Lecture extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'title' => array
                (
                    array('not_empty','讲座标题不能为空'),

                ),

                'content' => array
                (
                    array('not_empty', '简介不能为空'),

                ),

                'speaker' => array
                (
                    array('not_empty', '演讲人不能为空'),

                ),

                'address' => array
                (
                    array('not_empty', '地址不能为空'),

                ),

                'datetime' => array
                (
                    array('not_empty', '讲座开始日期不能为空'),
