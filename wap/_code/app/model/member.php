...
/**
 * Member 封装来自 wx_member 数据表的记录及领域逻辑
 */
        ...
        (
            ...
            (
                ...
                'acluser' => array(
                    ...
                    'password_prop' => 'pass',
                    'acl_data_props' => 'id,username,cid,name',
                    'encode_type' => 'cleartext',
                ),
            ),

            // 用什么数据表保存对象
            'table_name' => 'wx_member',
            ...
            (
                'name' => array
                (
                    array('max_length', 64, '姓名不能超过 64 个字符'),

                ),

                'cid' => array
                (
                    array('max_length', 64, '身份证不能超过 64 个字符'),

                ),

                'tel' => array
                (
                    array('max_length', 32, '手机号码不能超过 32 个字符'),

                ),

                'username' => array
                (
                    array('max_length', 64, '用户名不能超过 64 个字符'),
                ...
                'jf' => array
                (
                    array('is_float', '积分必须是一个浮点数'),

                ),

                'source' => array
                (
                    array('is_int', '数据来源(哪类报名)必须是一个整数'),

                ),

                'sid' => array
                (
                    array('is_int', '对应报名id必须是一个整数'),
