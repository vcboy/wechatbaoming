...
abstract class Controller_Abstract extends QController_Abstract
{
    ...
    public function set_back() {
        $_SESSION['jibo_backurl'] = $this->_context->referer();
    }
    /**
     * 返回url
     */
    public function go_back($flag=1) {
        //flag为1时返回设置的url,flag为0时直接返回上一页
        $url = $flag ? $_SESSION['jibo_backurl'] : $this->_context->referer();
